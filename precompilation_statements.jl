...
precompile(Tuple{typeof(GLNS.main), Array{String, 1}, Float64, Int64, Array{Int64, 1}, Array{Int64, 2}, Array{Bool, 2}, Bool, Int64, Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#79#threadsfor_fun#17"{GLNS.var"#79#threadsfor_fun#15#18"{UInt64, Int64, Array{Array{Int64, 1}, 1}, Array{Int64, 2}, Array{Bool, 2}, Bool, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Bool})
...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#79#threadsfor_fun#17"{GLNS.var"#79#threadsfor_fun#15#18"{UInt64, Int64, Array{Array{Int64, 1}, 1}, Array{Int64, 2}, Array{Bool, 2}, Bool, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Int64}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:socket_port, :max_time, :max_removals_cap, :output, :max_removal_fraction, :new_socket_each_instance, :num_iterations, :mode, :verbose, :latest_improvement, :first_improvement), Tuple{Int64, Float64, Int64, Base.SubString{String}, Float64, Int64, Float64, Base.SubString{String}, Int64, Float64, Float64}}, typeof(GLNS.solver), String, PythonCall.Wrap.PyArray{Int64, 1, true, true, Int64}, UInt64, Int64, Int64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, PythonCall.Wrap.PyArray{Bool, 2, true, true, Bool}, Bool, Array{Int64, 1}, Float64, Float64, Int64, Base.Dict{String, Any}, Bool, Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#79#threadsfor_fun#17"{GLNS.var"#79#threadsfor_fun#15#18"{UInt64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, PythonCall.Wrap.PyArray{Bool, 2, true, true, Bool}, Bool, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Bool})
