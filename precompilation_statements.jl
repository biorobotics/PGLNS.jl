...
precompile(Tuple{typeof(GLNS.main), Array{String, 1}, Float64, Int64, Array{Int64, 1}, Array{Int64, 2}, Int64})
...
# If we want to use with sockets
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:mode, :output, :verbose, :socket_port, :max_time, :new_socket_each_instance, :num_iterations), Tuple{Base.SubString{String}, Base.SubString{String}, Int64, Int64, Float64, Int64, Float64}}, typeof(GLNS.solver), String, Array{Int64, 1}, UInt64, Int64, Int64, Int64, Array{Array{Int64, 1}, 1}, Array{Int64, 2}, Array{Int64, 1}, Float64, Float64, Int64, Base.Dict{String, Any}, Bool})
