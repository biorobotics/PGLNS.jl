...
precompile(Tuple{FileWatching.Pidfile.var"##mkpidlock#7", Base.Pairs{Symbol, Integer, Tuple{Symbol, Symbol}, NamedTuple{(:stale_age, :wait), Tuple{Int64, Bool}}}, typeof(FileWatching.Pidfile.mkpidlock), Base.var"#1110#1111"{Base.PkgId}, String, Int32})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:reasons, :loadable_exts), Tuple{Base.Dict{String, Int64}, Nothing}}, typeof(Base.compilecache), Base.PkgId, String})
precompile(Tuple{typeof(Base.create_expr_cache), Base.PkgId, String, String, String, Array{Pair{Base.PkgId, UInt128}, 1}, Base.Cmd, Base.CacheFlags, IO, IO, Nothing})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#95#threadsfor_fun#21"{GLNS.var"#95#threadsfor_fun#19#22"{UInt64, Int64, Array{Array{Int64, 1}, 1}, Array{Int64, 2}, Array{Int64, 1}, Bool, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Bool})
...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#95#threadsfor_fun#21"{GLNS.var"#95#threadsfor_fun#19#22"{UInt64, Int64, Array{Array{Int64, 1}, 1}, Array{Int64, 2}, Array{Int64, 1}, Bool, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Int64}})
precompile(Tuple{typeof(Base.setindex!), Array{Float64, 1}, Float64, Int64})
precompile(Tuple{typeof(Base.:(>)), Int64, Float64})
precompile(Tuple{typeof(GLNS.remove_insert_dp), GLNS.Tour, Array{Int64, 2}, Array{Int64, 1}, GLNS.Distsv, Array{Array{Int64, 1}, 1}, Base.Dict{String, Any}, Base.Dict{Symbol, Any}, Symbol, Int64, Float64, GLNS.VDInfo, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Bool, Array{Float64, 1}, Int64})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#95#threadsfor_fun#21"{GLNS.var"#95#threadsfor_fun#19#22"{UInt64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Bool, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Bool})
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#95#threadsfor_fun#21"{GLNS.var"#95#threadsfor_fun#19#22"{UInt64, Int64, Array{Array{Int64, 1}, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Bool, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Real}, Float64, Base.Dict{Symbol, Any}, Float64, Base.UnitRange{Int64}}}, Int64}})
precompile(Tuple{typeof(GLNS.remove_insert_dp), GLNS.Tour, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, GLNS.Distsv, Array{Array{Int64, 1}, 1}, Base.Dict{String, Any}, Base.Dict{Symbol, Any}, Symbol, Int64, Float64, GLNS.VDInfo, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Bool, Array{Float64, 1}, Int64})
