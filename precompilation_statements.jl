...
precompile(Tuple{typeof(Base.empty), Base.Dict{Symbol, GLNS.Atomic{Int64}}, Type{Symbol}, Type{GLNS.Atomic{T} where T}})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Symbol, GLNS.Atomic{T} where T}, Base.Dict{Symbol, GLNS.Atomic{Int64}}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, GLNS.Atomic{T} where T}, GLNS.Atomic{Bool}, Symbol})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, GLNS.Atomic{T} where T}, Tuple{Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, GLNS.Atomic{Bool}}, Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, Int64}, Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, Float64}}, Int64})
precompile(Tuple{typeof(Base.empty), Base.Dict{Symbol, GLNS.Atomic{T} where T}, Type{Symbol}, Type{Any}})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, GLNS.Atomic{T} where T}})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, GLNS.Atomic{Bool}}, Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, Int64}, Pair{Symbol, GLNS.Atomic{Int64}}, Pair{Symbol, Float64}}, Int64})
...
precompile(Tuple{typeof(Base.getproperty), GLNS.Atomic{Int64}, Symbol, Symbol})
precompile(Tuple{typeof(GLNS.tour_copy), GLNS.Tour})
precompile(Tuple{typeof(Base.:(*)), Float64, Float64, Int64})
precompile(Tuple{Type{GLNS.Atomic{Float64}}, Float64})
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#81#threadsfor_fun#17"{GLNS.var"#81#threadsfor_fun#15#18"{UInt64, Int64, Array{Int64, 2}, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, GLNS.Atomic{Int64}, GLNS.Atomic{Int64}, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Array{Int64, 1}, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Any}, Float64, Base.Dict{Symbol, Any}, Float64, GLNS.Atomic{Float64}, GLNS.Atomic{Int64}, Base.UnitRange{Int64}}}, Bool})
...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#81#threadsfor_fun#17"{GLNS.var"#81#threadsfor_fun#15#18"{UInt64, Int64, Array{Int64, 2}, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, GLNS.Atomic{Int64}, GLNS.Atomic{Int64}, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Array{Int64, 1}, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Any}, Float64, Base.Dict{Symbol, Any}, Float64, GLNS.Atomic{Float64}, GLNS.Atomic{Int64}, Base.UnitRange{Int64}}}, Int64}})
precompile(Tuple{typeof(Base.getproperty), GLNS.Atomic{Bool}, Symbol, Symbol})
precompile(Tuple{typeof(Base.:(>)), Int64, Float64})
precompile(Tuple{typeof(GLNS.remove_insert), GLNS.Tour, Array{Int64, 2}, Array{Int64, 1}, GLNS.Distsv, Array{Array{Int64, 1}, 1}, Base.Dict{String, Any}, Base.Dict{Symbol, Any}, Symbol, Base.ReentrantLock, Base.ReentrantLock, Bool, Array{Float64, 1}, Int64})
...
precompile(Tuple{typeof(Base.setproperty!), GLNS.Atomic{Int64}, Symbol, Int64, Symbol})
precompile(Tuple{typeof(Base.setproperty!), GLNS.Atomic{Bool}, Symbol, Bool, Symbol})
precompile(Tuple{typeof(Base.:(!=)), Base.SubString{String}, String})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#81#threadsfor_fun#17"{GLNS.var"#81#threadsfor_fun#15#18"{UInt64, Int64, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, GLNS.Atomic{Int64}, GLNS.Atomic{Int64}, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Array{Int64, 1}, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Any}, Float64, Base.Dict{Symbol, Any}, Float64, GLNS.Atomic{Float64}, GLNS.Atomic{Int64}, Base.UnitRange{Int64}}}, Bool})
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#81#threadsfor_fun#17"{GLNS.var"#81#threadsfor_fun#15#18"{UInt64, Int64, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, Bool, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, GLNS.Atomic{Int64}, GLNS.Atomic{Int64}, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, Array{Array{Array{Int64, 1}, 1}, 1}, GLNS.Distsv, UInt64, Base.Dict{Symbol, Any}, Float64, Base.Dict{Symbol, Any}, Float64, GLNS.Atomic{Float64}, GLNS.Atomic{Int64}, Base.UnitRange{Int64}}}, Int64}})
precompile(Tuple{typeof(GLNS.remove_insert), GLNS.Tour, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Int64, 1}, GLNS.Distsv, Array{Array{Int64, 1}, 1}, Base.Dict{String, Any}, Base.Dict{Symbol, Any}, Symbol, Base.ReentrantLock, Base.ReentrantLock, Bool, Array{Float64, 1}, Int64})
