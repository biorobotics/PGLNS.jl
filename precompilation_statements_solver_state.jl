...
precompile(Tuple{typeof(Base.:(var"==")), CondaPkg.ChannelSpec, CondaPkg.ChannelSpec})
...
precompile(Tuple{typeof(GLNS.initialize_solver_state), Array{String, 1}, Int64, Array{Int64, 1}, Array{Int64, 2}, Array{Bool, 2}, Bool, Int64, Array{Int64, 1}})
...
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Tuple{Pair{Symbol, Int64}, Pair{Symbol, Int64}, Pair{Symbol, Int64}, Pair{Symbol, String}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Int64}, Pair{Symbol, Array{String, 1}}}})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, Int64}, Pair{Symbol, Int64}, Pair{Symbol, Int64}, Pair{Symbol, String}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Float64}, Pair{Symbol, Int64}, Pair{Symbol, Array{String, 1}}}, Int64})
...
precompile(Tuple{typeof(GLNS.initial_tour!), GLNS.Tour, Array{Int64, 2}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Int64, Base.Dict{Symbol, Any}, Int64, Array{Int64, 1}, Array{Int64, 1}, Int64, Float64})
...
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#86#threadsfor_fun#16"{GLNS.var"#86#threadsfor_fun#14#17"{Int64, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, UInt64, Float64, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Base.Dict{Symbol, Real}, Base.Dict{Symbol, Any}, Bool, Base.Dict{String, Any}, Array{Int64, 1}, Bool, Array{Bool, 2}, Array{Int64, 2}, Array{Array{Int64, 1}, 1}, Int64, UInt64, Base.UnitRange{Int64}}}, Bool})
...
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#86#threadsfor_fun#16"{GLNS.var"#86#threadsfor_fun#14#17"{Int64, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, UInt64, Float64, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Base.Dict{Symbol, Real}, Base.Dict{Symbol, Any}, Bool, Base.Dict{String, Any}, Array{Int64, 1}, Bool, Array{Bool, 2}, Array{Int64, 2}, Array{Array{Int64, 1}, 1}, Int64, UInt64, Base.UnitRange{Int64}}}, Int64}})
...
precompile(Tuple{typeof(GLNS.tour_cost), Array{Int64, 1}, Array{Int64, 2}})
...
precompile(Tuple{typeof(PythonCall.JlWrap.pyjlarray_array_interface), Array{Bool, 2}})
...
precompile(Tuple{typeof(GLNS.initial_tour!), GLNS.Tour, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Int64, Base.Dict{Symbol, Any}, Int64, Array{Int64, 1}, Array{Int64, 1}, Int64, Float64})
precompile(Tuple{typeof(Base.Threads.threading_run), GLNS.var"#86#threadsfor_fun#16"{GLNS.var"#86#threadsfor_fun#14#17"{Int64, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, UInt64, Float64, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Base.Dict{Symbol, Real}, Base.Dict{Symbol, Any}, Bool, Base.Dict{String, Any}, Array{Int64, 1}, Bool, PythonCall.Wrap.PyArray{Bool, 2, true, true, Bool}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Array{Int64, 1}, 1}, Int64, UInt64, Base.UnitRange{Int64}}}, Bool})
precompile(Tuple{Base.Threads.var"#1#2"{GLNS.var"#86#threadsfor_fun#16"{GLNS.var"#86#threadsfor_fun#14#17"{Int64, Array{Float64, 1}, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Base.ReentrantLock, Array{Base.ReentrantLock, 1}, Base.ReentrantLock, Array{Tuple{Float64, Array{Int64, 1}, Int64}, 1}, UInt64, Float64, Array{Array{Int64, 1}, 1}, GLNS.Distsv, Base.Dict{Symbol, Real}, Base.Dict{Symbol, Any}, Bool, Base.Dict{String, Any}, Array{Int64, 1}, Bool, PythonCall.Wrap.PyArray{Bool, 2, true, true, Bool}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}, Array{Array{Int64, 1}, 1}, Int64, UInt64, Base.UnitRange{Int64}}}, Int64}})
precompile(Tuple{typeof(GLNS.tour_cost), Array{Int64, 1}, PythonCall.Wrap.PyArray{Int64, 2, true, true, Int64}})
